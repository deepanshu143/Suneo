...
def export_data(update, context):
    ...
    f = open("SuneoManagerbot{}.backup".format(chat_id), "w")
    ...
    context.bot.sendDocument(
        current_chat_id,
        document=open("SuneoManagerbot{}.backup".format(chat_id), "rb"),
        caption="*Successfully Exported backup:*\nChat: `{}`\nChat ID: `{}`\nOn: `{}`\n\nNote: This `Suneo Manager` was specially made for notes.".format(
            chat.title, chat_id, tgl
        ),
        timeout=360,
    ...
    os.remove("SuneoManagerbot{}.backup".format(chat_id))  # Cleaning file
...
*Only for group owner:*
 ...
 ✪ /import: Reply to the backup file for the butler / SuneoManagerbot group to import as much as possible, making transfers very easy! \
