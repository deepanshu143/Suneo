...
def info(update: Update, context: CallbackContext):
    ...
    if disaster_level_present:
        ...
        text += ' [<a href="https://t.me/SuneoAndLucarioUpdates/13">?</a>]'.format(bot.username)
...
*What is that health thingy?*
 Come and see [HP System explained](https://t.me/SuneoAndLucarioUpdates/11)
"""
